...
We worked on the Prep the Pitch slideshow for our group. We decided on our own 2 custom features to implement: so far we came up with gps tracking to route users with shared interests (within range) to one another, and allowing users to take their chat to other communication apps. 
