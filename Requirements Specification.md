...
Jennifer Yan(jenniy16@uci.edu), Zhengyu Dong(zhengyd6@uci.edu), Niharika Yalla(yallan@uci.edu), Yuxuan Huang(yuxuah27@uci.edu), Xinlei Liang(xinleil2@uci.edu)

Executive Summary

The app Kinnect is a geolocator app that allows users with shared interests to locate each other on a map and interact with each other through groupchats. In the app, the users could search the people they want to meet by the tags, and people with that tag will show their location on the map. 
